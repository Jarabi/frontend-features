...
const features = [
    {
        ...
        icon: '📜',
        color: '#3b82f6',
        path: '/frontend-features/1-infinite-scroll/',
    ...
    },
    {
        ...
        icon: '🔍',
        color: '#3b82f6',
        path: '/frontend-features/2-debounced-search/',
    ...
    },
    {
        ...
        icon: '💀',
        color: '#10b981',
        path: '/frontend-features/3-search-scroll-skeletons/',
    ...
    },
    {
        ...
        icon: '🍞',
        color: '#10b981',
        path: '/frontend-features/4-toast-notifications/',
    ...
    },
    {
        ...
        icon: '🎭',
        color: '#ef4444',
        path: '/frontend-features/5-modal-dialog-system/',
    ...
    },
    {
        ...
        icon: '🔄',
        color: '#ef4444',
        path: '/frontend-features/6-drag-and-drop-system/',
